...
function Request (options) {
  ...
  const autoFillHeaders = options.autoFillHeaders === undefined ? true : options.autoFillHeaders
  ...
  if ('user-agent' in this.headers === false && autoFillHeaders) {
  ...
  if (payload && typeof payload !== 'string' && !payloadResume && !Buffer.isBuffer(payload)) {
    ...
    if ('content-type' in this.headers === false && autoFillHeaders) {
